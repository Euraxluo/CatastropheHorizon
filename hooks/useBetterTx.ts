...
export type BetterSignAndExecuteTransactionWithSponsorProps<
  TArgs extends unknown[] = unknown[]
> = {
  tx: (...args: TArgs) => Transaction;
};
...
>({
  ...
  const handleSignAndExecuteTransaction = (
    ...
    let successCallback:
      | ((
          result: SuiTransactionBlockResponse | undefined
        ) => void | Promise<void>)
      | undefined;
...
export function useBetterSignAndExecuteTransactionWithSponsor<
  TArgs extends unknown[] = unknown[]
>(props: BetterSignAndExecuteTransactionWithSponsorProps<TArgs>) {
  ...
  const handleSignAndExecuteTransactionWithSponsor = (
    ...
    let successCallback:
      | ((
          result: CreateSponsoredTransactionApiResponse
        ) => void | Promise<void>)
      | undefined;
    let errorCallback: ((error: Error) => void) | undefined;
    let settledCallback:
      | ((
          result: CreateSponsoredTransactionApiResponse | undefined
        ) => void | Promise<void>)
      | undefined;
    let beforeExecuteCallback: (() => Promise<boolean | void>) | undefined;
